            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>"><i class="fa fa-cash"></i><strong>Carteira Digital</strong></a>
                    </div>
                    <!-- end:navbar-header -->
                    <ul class="nav navbar-nav navbar-right top-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php if(Auth::check()): ?>
                                <li><a href="<?php echo e(route('dashboard')); ?>"><i class=" fa fa-suitcase"></i>Perfil</a></li>
...
</html>	<?php /**PATH D:\Meus repositórios github\Testando-multiuser\resources\views/layouts/app.blade.php ENDPATH**/ ?>
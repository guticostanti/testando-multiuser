...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('cnpj')); ?>" name="cnpj" id="inputEmail1" placeholder="CNPJ">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <button type="submit" class="btn btn-primary">Criar Conta</button>
                                    <a href="<?php echo e(route('welcome')); ?>" class="btn btn-primary" >Voltar para Login</a>
                            </div>
                        </div>
                    </form>
                </div>

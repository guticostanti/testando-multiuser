                    ...
                    <ul class="nav navbar-nav navbar-right top-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php if(Auth::check()): ?>
                                <li><a href="<?php echo e(route('pf.profile')); ?>"><i class=" fa fa-suitcase"></i>Perfil</a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="">
                                    <a href="<?php echo e(route('pf.presend')); ?>">
                                        <div class="text-center">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(route('pf.profile')); ?>"><i class="fa fa-user"></i>Perfil</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
...
</html>	<?php /**PATH D:\Meus repositórios github\Payment-Wallet\resources\views/layouts/pf-app.blade.php ENDPATH**/ ?>